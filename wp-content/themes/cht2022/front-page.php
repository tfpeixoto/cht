      ...
      <div class="col-12 col-md-6">
        <div class="balao-contatos">
          ...
          <h3 class="text-phone float-md-left mr-1 mr-md-5">
            <a href="tel:3125340546" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
          ...
          <h3 class="text-phone">
            <a href="https://api.whatsapp.com/send?phone=5531971486378&text=Ol%C3%A1!" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              ...
              </svg> <small>31</small> 97148.6378</a>
          </h3>
        </div>
      </div>
    </div>
