...
<head>
  ...
  })(window,document,'script','dataLayer','GTM-5HXGPCX');</script>
...
<body <?php body_class(); ?>>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5HXGPCX"
  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->

  <header class="bg-vermelho mb-5 shadow">
    <div class="container">
      <div class="flex-row">
        <nav class="navbar navbar-expand-lg bg-transparent d-flex justify-content-between">
          ...
          <div class="d-flex order-2 order-md-3">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#nav-mobile"
              aria-controls="nav-mobile" aria-expanded="false" aria-label="Alterna navegação">
          ...
          <div class="contatos d-none d-md-flex order-4 order-md-4">
            <ul class="list-unstyled list-inline">
              <li class="list-inline-item">
                <a href="tel:3125340546" target="_blank" class="text-white"><i class="fas fa-phone text-white"></i> <small>31</small> 2534.0546</a></li>
              <li class="list-inline-item ml-3"><a href="https://api.whatsapp.com/send?phone=5531971486378&text=Ol%C3%A1!" target="_blank" class="text-white"><i class="fab fa-whatsapp text-white"></i> <small>31</small> 97148.6378</a></li>
            </ul>
          </div>        
        </nav>
      </div>
